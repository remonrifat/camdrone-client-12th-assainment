        ...
        <Container>
            <Grid container spacing={2}>
                <Grid item xs={12} md={6}>
                    <img style={{ width: '100%', mt: '5' }} src={login} alt="" />
                </Grid>
                <Grid item sx={{ mt: 8 }} xs={12} md={6}>
                    ...
                    {!isLoading && <form onSubmit={handleLoginSubmit}>
                        ...
                        <NavLink style={{ textDecoration: 'none' }} to='/login'><Button sx={{ color: 'secondary.main', fontFamily: 'Monospace' }} variant="outlined">Already Register? please Login</Button>
                        </NavLink>

                    </form>}
                    {isLoading && <CircularProgress />}
                    {user?.email && <Alert severity="success">User Created Successfully — Congratulation!</Alert>
                    }
